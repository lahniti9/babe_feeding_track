...
class HeightStatsController extends GetxController {
  HeightStatsController({required this.childId});
  ...
  double get latestHeight => points.isNotEmpty ? points.last.value : 0.0;
